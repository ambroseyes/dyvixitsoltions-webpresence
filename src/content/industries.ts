...
/**
 * Sector pages. These describe pressures and risks that are characteristic of
 * each sector — they do not claim D’Yvix has delivered in that sector. Sector
 * evidence appears only once a client-approved case study exists.
 */
