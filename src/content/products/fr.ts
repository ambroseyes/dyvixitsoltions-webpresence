...
export const productsFr: Record<ProductSlug, ProductText> = {
  "back-node": {
    tagline: "L’automatisation des processus métier — iPaaS, workflows visuels, RPA et IA dans une interface sans code.",
    description:
    ...
    capabilities: [
      { title: "Workflows visuels", description: "Des processus conçus comme des workflows dans une interface sans code, puis exécutés et tracés étape par étape." },
      { title: "Intégration (iPaaS)", description: "Des connecteurs qui permettent aux workflows de lire et d’agir sur les systèmes que l’organisation exploite déjà." },
      { title: "Automatisation robotisée (RPA)", description: "Un service de RPA pour les étapes répétitives que les systèmes ne savent pas encore réaliser par API." },
      { title: "L’IA dans le workflow", description: "Des capacités d’IA disponibles comme étapes de workflow, dont la recommandation." },
      { title: "Une exécution résiliente", description: "Exécution en file d’attente, avec nouvelles tentatives et temporisation exponentielle sur les erreurs passagères, et arrêt immédiat sur les erreurs métier." },
      { title: "Exploitée comme un service", description: "Authentification, limitation de débit, supervision et facturation intégrées à la plateforme." },
    ],
    architecture: [
