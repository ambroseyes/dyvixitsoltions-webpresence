...
export const productsEn: Record<ProductSlug, ProductText> = {
  "back-node": {
    tagline:
      "Business process automation — iPaaS, visual workflows, RPA and AI in one no-code interface.",
    description:
    ...
    capabilities: [
      {
        ...
        description:
          "Processes designed as workflows in a no-code interface, then executed and traced step by step.",
      },
      {
        title: "Integration (iPaaS)",
        description:
          "Connectors that let workflows read from and act on the systems an organisation already runs.",
      },
      {
        title: "Robotic process automation",
        description:
          "An RPA service for the repetitive steps that systems cannot yet do through an API.",
      },
      {
        title: "AI in the workflow",
        description: "AI capabilities available as workflow steps, including recommendation.",
      },
      {
        title: "Resilient execution",
        description:
          "Queued execution with retries and exponential back-off on transient failures, and an immediate stop on business errors.",
      },
      {
        title: "Operated like a service",
        description:
          "Authentication, rate limiting, monitoring and billing built into the platform.",
      },
    ],
    architecture: [
