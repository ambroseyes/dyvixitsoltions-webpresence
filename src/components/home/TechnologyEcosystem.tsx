 ...
 */
export function TechnologyEcosystem({ lang, index = "05" }: { lang: Locale; index?: string }) {
  const t = getDictionary(lang).home.technology;
  const categories = getHome(lang).techCategories;
